...
@section('content')
  <div class="container">
    <div class="row">
      <div class="col-lg-12">
        <h3>Add Events Schedule Detail</h3>
      </div>
    </div>
    ...
    <form action="/eventSchedule/add" method="post">
      @csrf
      <div class="row">
         <div class="col-md-12">
          <strong>Title</strong>
        ...
        <div class="col-md-12">
          ...
          <input type="text" name="stime" class="form-control" placeholder="eg:- 7 AM" >
        </div>

        <div class="col-md-12">
            <strong>End Time</strong>
            <input type="text" name="etime" class="form-control" placeholder="eg:- 10 PM" >
        </div>
