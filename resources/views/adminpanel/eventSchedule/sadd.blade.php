                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <form  method ="POST" action="/admin/eventSchedule/add">
                                        @csrf
                                            ...
                                            <div class="form-group">
                                               <p class="text-muted m-b-15 f-s-12">Start Time</p>
                                                <input type="time" class="form-control input-default" name="stime" placeholder="Start time" required>
                                            </div>
                                             <div class="form-group">
                                                <p class="text-muted m-b-15 f-s-12">End Time</p>
                                                <input type="time" class="form-control input-default" placeholder="End Time" name="etime" required>
                                            </div>
