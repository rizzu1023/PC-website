                        ...
                        <div class="col-lg-8 p-r-0 title-margin-right">
                            <div class="page-header">
                                <div class="page-title">
                                    ...
                                    <button type="button" class="btn btn-primary m-b-10 m-l-5">+  Add Winner</button>
                                </div>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <table id="row-select" class="display table table-borderd table-hover">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <button type="button" class="btn btn-success btn-sm m-b-10 m-l-5">Schedule</button></td>
                                                </tr>
                                            </tbody>
                                            </tfoot>
                                        </table>
