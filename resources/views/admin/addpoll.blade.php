            ...
            <div class="nano">
                <div class="nano-content">
                    ...
                    <ul>
                        ...
                        <li  class="active"><a class="sidebar-sub-toggle"><i class="ti-bar-chart-alt"></i> Poll  </a>
                                ...
                                <div class="card-body">
                                    <div class="basic-form">
                                        <form>
                                            ...
                                            <div class="form-group">
                                                <textarea class="form-control input-default" name="question"placeholder="Question" required></textarea>
                                            </div>
                                            <div class="form-group">
                                                <input type="text" class="form-control input-default" name="question" placeholder="Option 1" required>
                                            </div>
                                            <div class="form-group">
                                                <input type="text" class="form-control input-default" name="question" placeholder="Option 2" required>
                                            </div>
                                            <div class="form-group">
                                                <input type="text" class="form-control input-default" name="question" placeholder="Option 3" required>
                                            </div>
                                            <div class="form-group">
                                                <input type="text" class="form-control input-default" name="question" placeholder="Option 4" required>
                                            </div>
