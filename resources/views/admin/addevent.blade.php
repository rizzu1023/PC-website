                                    ...
                                    <div class="basic-form">
                                        <form>
                                            <div class="form-group">
                                                <input type="text" class="form-control input-default " name="event_name" placeholder="Event Name" required>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                               <p class="text-muted m-b-15 f-s-12">Upload Image</p>
                                                <input type="file" class="form-control input-default" name="banner_image" >
                                            </div>
                                             <div class="form-group">   
                                                <textarea   class="form-control input-default" name="event_discription" placeholder="Event Discription"></textarea>
                                            </div>
                                            <div class="form-group">
                                                <textarea   class="form-control input-default" name="event_theme" placeholder="Event Theme"></textarea>
                                            </div>
                                             <div class="form-group">
