            ...
            <div class="nano">
                <div class="nano-content">
                    ...
                    <ul>
                        ...
                        <li class="active"><a class="sidebar-sub-toggle"><i class="ti-user"></i> PC Team </a>
                        ...
                        <div class="col-lg-8 p-r-0 title-margin-right">
                            <div class="page-header">
                                <div class="page-title">
                                    ...
                                    <button type="button" class="btn btn-primary m-b-10 m-l-5">+  Add Member Details</button>
                                </div>
                            </div>
                        </div>
                    </div>
