                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <form  method ="POST" action="/admin/Workshopnew/add">
                                        @csrf
                                        
                                            <div class="form-group">
                                                <label class="text-muted m-b-15 f-s-12">Duration</label>
                                                <input type="text" class="form-control input-default placeholder="Workshop name" name="duration" >
                                            </div>
                                            <div class="form-group">
                                               <p class="text-muted m-b-15 f-s-12">Workshop date</p>
                                                <input type="text" class="form-control input-default" placeholder="Username" name="workshopdate" >
                                            </div>
                                            
                                             <div class="form-group">
                                                <p class="text-muted m-b-15 f-s-12">Time</p>
                                                <input type="time" class="form-control input-default" placeholder="Time" name="workshoptime" required>
                                            </div>
                                             ...
                                             <div class="form-group">
                                                ...
                                                <input type="fees" class="form-control input-default" placeholder="Fees" name="fees" required>
                                            </div>
                                           
                                            <div class="form-group">
                                                <p class="text-muted m-b-15 f-s-12">Notes</p>
                                                <input type="file" class="form-control input-default" placeholder="Upload pdf" name="notes" required>
                                            </div>
