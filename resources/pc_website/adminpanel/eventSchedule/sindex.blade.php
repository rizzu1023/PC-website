                    ...
                    <div class="row">
                        <div class="col-lg-8 p-r-0 title-margin-right">
                            <div class="page-header">
                                    ...
                                    <a class="btn btn-sm btn-success"href="/admin/eventSchedule/add">Add Schedule</a>
                                    </div>
                                            ...
                                            <thead>
                                             ...
                                             @foreach($eventSchedule as $eventSchedule)
                                                <tr>
                                                    ...
                                                    <div class="col-sm-2">
                                                        <a class="btn btn-sm btn-warning" href="/admin/eventSchedule/edit/{{$eventSchedule->id}} ">Edit</a>
                                                    </div>
                                                    <form action="/admin/eventSchedule/delete/{{$eventSchedule->id}}" method="POST">
                                                        @csrf
                                                            <div class="col-sm-2">
